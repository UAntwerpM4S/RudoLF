...
class PhysicsSimulator:
    ...
    def step(self, action: np.ndarray, enable_smoothing: bool) -> np.ndarray:
        """
        ...
        self._state = np.array(self.dynamics.integrate(self._state.copy(), [du, dv, dr], self.dt), dtype=np.float32)

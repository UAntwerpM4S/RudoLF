...
class PySimEnv(BaseEnv):
    ...
    def __init__(
        ...
        self.fossen_model = FossenShipModel(ship_length=110.0, ship_mass=3.86e6)    # Myzako specifications
    ...
    def _initialize_state(self) -> None:
        ...
        if len(self.checkpoints) > self.checkpoint_index:
            ...
            ship_angle = self.normalize_angle(self._safe_heading_from_vector(direction_vector))
        else:
            ship_angle = 0.0
